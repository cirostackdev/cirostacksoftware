...
// ── Convenience wrappers (mirror the pixel helpers for Academy) ─────────────

export function sendServerPageView() {
  sendServerEvent({ event_name: "PageView" });
}

export async function sendServerCompleteRegistration(params?: {
  email?: string;
  content_name?: string;
  value?: number;
  currency?: string;
...
export function sendServerStartTrial(params?: { value?: number; currency?: string }) {
  sendServerEvent({
...
export function sendServerInitiateCheckout(params?: {
  content_name?: string;
  value?: number;
  currency?: string;
}) {
...
export function sendServerSubscribe(params?: { value?: number; currency?: string }) {
  sendServerEvent({
...
export function sendServerSearch(params?: { search_string?: string }) {
  sendServerEvent({
    event_name: "Search",
    custom_data: params,
  });
